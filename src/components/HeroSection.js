  ...
  return (
    <section className="relative h-[80vh] overflow-hidden flex flex-col items-center justify-center text-white text-center gap-6 rounded-b-2xl bg-white">
      ...
      <div className="relative z-20 px-4">
        <h1 className="text-[25px] md:text-[2rem] xs:[1.5rem] mb-4">Briefly describe your services</h1>
        <p className="text-7xl/[1.2] md:text-[1.25rem] xs:text-[1rem] mb-8 font-[Inter] font-black bg-gradient-to-r from-[#FBB011] via-white to-[#FBB011] bg-clip-text text-transparent">
          Capturing Moments, <br /> Crafting Stories
        </p>
        <button className="px-8 py-3 md:px-[1.5rem] md:py-[0.5rem] xs:px-[1.2rem] xs:py-[0.4rem] text-lg md:text-[0.9rem] xs:text-[0.8rem] font-semibold border border-colorOne text-colorOne bg-transparent cursor-pointer transition-colors duration-300 ease-in-out rounded hover:bg-colorOne hover:text-black">
